  ...
  return (
    <div>
      <div className="mb-[2rem] w-full inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground">
        ...
        <NavLink to="programs"  className={({ isActive }) => `${base} ${isActive ? active : ""}`}> Programs </NavLink>
        <NavLink to="courses"  className={({ isActive }) => `${base} ${isActive ? active : ""}`}> Courses </NavLink>
        <NavLink to="cohorts"  className={({ isActive }) => `${base} ${isActive ? active : ""}`}>  Cohorts</NavLink>
